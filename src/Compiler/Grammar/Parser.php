 ...
 * Generated at: 13-07-2019 17:53:01
 *
 * --- DO NOT EDIT THIS FILE ---
 */
class Parser extends \Phplrt\Parser\Parser
{
    ...
    public const _WHITESPACE           = '_WHITESPACE';
    public const _COMMENT              = '_COMMENT';
    public const _BLOCK_COMMENT        = '_BLOCK_COMMENT';
    ...
    protected const LEXER_TOKENS = [
        ...
        self::T_DELEGATE            => '\\->',
        self::T_END_OF_RULE         => ';',
        self::_WHITESPACE           => '(\\xfe\\xff|\\x20|\\x09|\\x0a|\\x0d)+',
        self::_COMMENT              => '//[^\\n]*',
        self::_BLOCK_COMMENT        => '/\\*.*?\\*/',
    ];
