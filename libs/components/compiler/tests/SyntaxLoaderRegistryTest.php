...
final class SyntaxLoaderRegistryTest extends TestCase
{
    ...
    public function testFormatIsToldByTheExtension(): void
    {
        ...
        self::assertInstanceOf(PPLoader::class, $registry->selectFor(new VirtualStringSource('/app/a.pp')));
        self::assertInstanceOf(PP2Loader::class, $registry->selectFor(new VirtualStringSource('/app/a.pp2')));
        self::assertInstanceOf(PP3Loader::class, $registry->selectFor(new VirtualStringSource('/app/a.pp3')));
    }
    ...
    public function testGrammarOfAnUnknownExtensionIsReadAsTheNewestFormat(): void
    {
        ...
        self::assertInstanceOf(PP3Loader::class, $registry->selectFor(new VirtualStringSource('/app/a.txt')));
        self::assertInstanceOf(PP3Loader::class, $registry->selectFor(new VirtualStringSource('/app/grammar')));
    }
