 ...
 */
final readonly class BranchPredictionConstructionParserAnalysisPass implements
    ParserAnalysisPassInterface
{
    public function process(ParserResultContext $context): void
    {
        ...
        $context->branchesByToken = $result;
    }
    ...
    private function expand(ParserResultContext $context, Alternation $rule): array
    {
        ...
        foreach ($rule->ruleIds as $branch) {
            $firsts[$branch] = $first = $this->calculateStartTokens($context, $branch);
