...
final readonly class PHPStanParsingBench
{
    ...
    {
        $config = new \PHPStan\PhpDocParser\ParserConfig(usedAttributes: []);
        $this->phpstanLexer = new \PHPStan\PhpDocParser\Lexer\Lexer($config);
        $constExprParser = new \PHPStan\PhpDocParser\Parser\ConstExprParser($config);
        $this->phpstanParser = new \PHPStan\PhpDocParser\Parser\TypeParser($config, $constExprParser);
    }
